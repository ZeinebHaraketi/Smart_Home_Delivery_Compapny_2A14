...
Person::Person()
{
idperson=0; nomperson=" "; telephone=0;
email=" "; idposte1=0; prenom=" ";
}
Person::Person(int idperson,QString nomperson,int telephone,QString email,int idposte1,QString prenom)
...
int Person::gettlfeperson(){return telephone;}
...
void Person::settlfperson(int telephone){this->telephone=telephone;}
